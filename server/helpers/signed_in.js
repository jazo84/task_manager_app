module.exports = (obj) => {
	...
	str += "<div class='modal-footer'><button type='submit' data-id=" + obj.id + " class='btn btn-primary' id='modal_form_submit'>Submit Task</button><button type='button' class='btn btn-secondary' data-dismiss='modal'>Close</button></form></div></div></div></div>";
